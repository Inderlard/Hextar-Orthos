...
#define STRING_CONFIG_H_AUTHOR "Inderlard" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "External MKS IDEX"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  22.48,  22.48 }
    #define DEFAULT_Ki_LIST {   2.97,   2.97 }
    #define DEFAULT_Kd_LIST {  42.47,  42.47 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 138.94
  #define DEFAULT_bedKi 27.03
  #define DEFAULT_bedKd 476.13
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200.5, 159.22, 800.8, 825.88, 825.88 } // MK10 93 pasos BMG 412.94 o 407.43
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, -11, -0.43 } // Ajustar autolevel

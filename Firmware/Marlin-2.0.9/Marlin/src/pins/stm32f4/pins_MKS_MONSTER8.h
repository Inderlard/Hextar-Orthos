...
//
// !!! IMPORTANTE EDITAR PARA EL SENSORLESS HOMING DEL X2 ACTUALMENTE PERTENECIENTE A E2 (Podria cambiarse a el puerto de E0 y desfasarlo todo de ser necesario)
...
#define E2_DIAG_PIN                         PA13  // Driver3 diag signal is connect to X+
#define E0_DIAG_PIN                         PC5   // Driver4 diag signal is connect to Y+
#define E1_DIAG_PIN                         PB12  // Driver5 diag signal is connect to Z+
...
#endif
//Driver3
#define E2_ENABLE_PIN                       PB6
#define E2_STEP_PIN                         PB5
#define E2_DIR_PIN                          PB4
#ifndef E2_CS_PIN
  #define E2_CS_PIN                         PB3
#endif
//Driver4
...
#define MT_DET_1_PIN                      PW_OFF
#define MT_DET_2_PIN                      PW_DET

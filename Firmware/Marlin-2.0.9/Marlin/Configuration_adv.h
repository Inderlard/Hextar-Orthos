 ...
 */
#define DUAL_X_CARRIAGE //* Ajustes del sistema IDEX
#if ENABLED(DUAL_X_CARRIAGE)
  #define X1_MIN_POS X_MIN_POS   // Set to X_MIN_POS
  #define X1_MAX_POS X_BED_SIZE  // Set a maximum so the first X-carriage can't hit the parked second X-carriage
  #define X2_MIN_POS    45       // Set a minimum to ensure the  second X-carriage can't hit the parked first X-carriage
  #define X2_MAX_POS   291.248       // Set this to the distance between toolheads when both heads are homed
 ...
 */
//#define Z_STEPPER_AUTO_ALIGN // !!! AUTOCALIBRATION AVANZADA SI TENEMOS MULTIPLES Z
...
// LCD Print Progress options
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define POWER_LOSS_PIN         PC5 // Pin to detect power loss. Set to -1 to disable default pin on boards without module.
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     1000  // (mm/s) Unload filament feedrate. This can be pretty fast.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   1000  // (mm/s) Load filament feedrate. This can be pretty fast.
 ...
 */
 ...
 // Ajustar corriente motores
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       630        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #if AXIS_IS_TMC(E2)
    #define E2_CURRENT      X_CURRENT
    #define E2_MICROSTEPS   X_MICROSTEPS
  ...
  // !!! ACTIVAR TRAS EDITAR EL PINOUT NECESARIO

// Ajustar sensibilidad homing sensorless
...
// Ajustar comandos propios
#define CUSTOM_MENU_MAIN
#if ENABLED(CUSTOM_MENU_MAIN)
  #define CUSTOM_MENU_MAIN_TITLE "Macros"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 User Script Done"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  #define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Home XY"
  #define MAIN_MENU_ITEM_1_GCODE "G28 X Y"
  //#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Z to 0"
  #define MAIN_MENU_ITEM_2_GCODE "G01 Z0"
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Prepare for lacquer"
  #define MAIN_MENU_ITEM_3_GCODE "G01 X0 Y230 Z80"
